            ...
            public void onSuccess(Update update) {
                ...
                if (UtilsLibrary.isUpdateAvailable(installedUpdate, update)) {
                    ...
                    if (UtilsLibrary.isAbleToShow(successfulChecks, showEvery)) {
                        switch (display) {
                            case DIALOG:
                                final DialogInterface.OnClickListener updateClickListener = btnUpdateClickListener == null ? new UpdateClickListener(context, updateFrom, update, update.getUrlToDownload()) : btnUpdateClickListener;
